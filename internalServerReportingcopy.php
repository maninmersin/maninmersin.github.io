...
$link = mysql_connect('localhost', 'lamp', 'lamp123');
...
$Store     		= $sample->Store['value'];
$Dept    		= $sample->Dept['value'];
...
$sqlQuizResult = "INSERT INTO tblQuizResult (quizCompanyName, quizDepartmentName, quizCourseName, quizLearnerName, quizLearnerID, quizLessonName, quizAttempts, quizTotalQuestions, quizName, quizScore, quizDate, quizStatus,quizDuration, quizRawScore, quizMaxScore, quizMinScore, Store, Dept, Role) 
VALUES ('$CompanyName','$DepartmentName','$CourseName','$LearnerName','$LearnerID','$LessonName','$QuizAttempts','$TotalQuestions','$Name','$Score','$Date','$Status','$QuizDuration','$RawScore','$MaxScore','$MinScore','$Store','$Dept','$Role',)";
